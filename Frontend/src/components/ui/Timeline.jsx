...
export const Timeline = ({
  ...
  return (
    (<div
      className="w-full bg-richblack-900  text-white dark:text-white dark:bg-neutral-950 font-sans md:px-10"
      ref={containerRef}>
      <div className="max-w-7xl mx-auto py-10 px-4 md:px-8 lg:px-10">
          <h1 className="text-4xl font-extrabold text-center text-blue-100">Coding Journey of ApnaGurukul </h1>
      </div>
